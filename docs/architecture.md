...
изменить — включая кинематику: `DynamicTerrainUpdate` интегрирует тела на
фиксированном шаге из `GameAdvanceWorld`, ничего не читая из мира. Тела пока ни
с чем не сталкиваются и не рисуются. Владеет подсистемой `GameState`.
