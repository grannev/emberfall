...
SOURCES := src/main.c src/smoke_test.c src/menu.c src/settings.c src/game.c src/game_events.c src/input.c \
	...
	src/presentation_fx_renderer.c src/reentry_renderer.c src/space_renderer.c src/backwall_debris.c src/weather_renderer.c src/beam_render.c src/sky_renderer.c src/terrain_grab_renderer.c \
