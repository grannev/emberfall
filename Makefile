...
SOURCES := src/main.c src/smoke_test.c src/game.c src/game_events.c src/input.c \
	...
	src/terrain_detach.c src/terrain_weld.c src/terrain_impulse.c src/terrain_damage.c src/terrain_interaction.c src/fluid_interaction.c src/terrain_fluid.c \
...
TEST_SOURCES := tests/world_tests.c src/game.c src/game_events.c src/input.c \
	...
	src/terrain_impulse.c src/terrain_damage.c src/terrain_interaction.c src/fluid_interaction.c src/terrain_fluid.c \
...
BENCH_SOURCES := bench/benchmark.c $(WORLD_SOURCES) src/player.c src/game.c \
	...
	src/terrain_damage.c src/terrain_interaction.c src/fluid_interaction.c src/terrain_fluid.c
