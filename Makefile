...
WORLD_SOURCES := src/materials.c src/world_storage.c src/world_simulation.c \
	...
	src/world_components.c src/world_fluid.c src/world_structures.c src/world_back_walls.c
SOURCES := src/main.c src/smoke_test.c src/menu.c src/settings.c src/game.c src/game_events.c src/input.c \
	$(WORLD_SOURCES) \
	...
	src/presentation_fx_renderer.c src/reentry_renderer.c src/space_renderer.c src/backwall_debris.c src/beam_render.c src/sky_renderer.c src/terrain_grab_renderer.c \
