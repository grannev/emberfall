...
const MaterialInfo MATERIALS[MATERIAL_COUNT] = {
    ...
    [MATERIAL_GRASS] = {
        .flora = true,
        .name = "GRASS", .color = {88, 142, 62, 255},
        .dark = {34, 72, 36, 255}, .light = {176, 212, 96, 255},
        .accent = {238, 214, 96, 255}, .accentShare = 2,
        .pattern = MATERIAL_PATTERN_BLADE,
    ...
    [MATERIAL_LUMEN] = {
        ...
        .solid = true,
        .emission = 0.8f,
        /* A lamp, a port, a strip of glyphs: set into the wall, not a wall. */
        .backdrop = true,
        .laserHeatRate = 900.0f,
        .chillRate = 240.0f,
        .density = 2.5f,
    ...
    [MATERIAL_LIMESTONE] = {
        .name = "LIMESTONE", .color = {196, 180, 146, 255},
        .dark = {150, 134, 104, 255}, .light = {226, 214, 184, 255},
        .accent = {238, 232, 214, 255}, .accentShare = 3,
        .pattern = MATERIAL_PATTERN_STRATA,
        .initialTemperature = AMBIENT_TEMPERATURE,
        .selfHeatTarget = AMBIENT_TEMPERATURE, .selfHeatRate = 0.006f,
        /* Burnt, it crumbles. */
        .onHeat = {true, MATERIAL_RUBBLE, 850.0f},
        .solid = true,
        .laserHeatRate = 760.0f,
        .chillRate = 240.0f,
        .density = 2.5f,
        .span = 44,
    },
    ...
    [MATERIAL_DRYBRUSH] = {
        .flora = true,
        .name = "DRYBRUSH", .color = {150, 124, 76, 255},
        .dark = {104, 82, 50, 255}, .light = {196, 168, 110, 255},
        .accent = {120, 98, 60, 255}, .accentShare = 6,
        .pattern = MATERIAL_PATTERN_FIBRE,
    ...
    [MATERIAL_KELP] = {
        ...
        .accent = {130, 118, 58, 255}, .accentShare = 5,
        .pattern = MATERIAL_PATTERN_FIBRE,
        .initialTemperature = 12.0f,
        .selfHeatTarget = 12.0f, .selfHeatRate = 0.02f,
        .onHeat = {true, MATERIAL_ASH, 180.0f},
        .solid = true,
        .laserHeatRate = 900.0f,
        .chillRate = 150.0f,
        .density = 0.3f,
    ...
    [MATERIAL_EMBERBLOOM] = {
        .flora = true,
        .name = "EMBERBLOOM", .color = {236, 108, 42, 255},
        .dark = {170, 58, 30, 255}, .light = {255, 176, 80, 255},
        .accent = {255, 226, 140, 255}, .accentShare = 8,
        .pattern = MATERIAL_PATTERN_CLUMP,
        .initialTemperature = 60.0f,
        .selfHeatTarget = 60.0f, .selfHeatRate = 0.0f,
        /* It grows beside lava: only real fire burns it. */
        .onHeat = {true, MATERIAL_FIRE, 600.0f},
        .solid = true,
        .emission = 0.55f,
        .laserHeatRate = 700.0f,
        .chillRate = 150.0f,
